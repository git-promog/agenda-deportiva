...
export const GRUPOS: WCGroup[] = [
  ...
  { nombre:'G', equipos:[{nombre:'RI de Irán',pj:2,pg:0,pe:2,pp:0,gf:2,gc:2,pts:2},{nombre:'Bélgica',pj:2,pg:0,pe:2,pp:0,gf:1,gc:1,pts:2},{nombre:'Nueva Zelanda',pj:1,pg:0,pe:1,pp:0,gf:2,gc:2,pts:1},{nombre:'Egipto',pj:1,pg:0,pe:1,pp:0,gf:1,gc:1,pts:1}] },
  { nombre:'H', equipos:[{nombre:'España',pj:2,pg:1,pe:1,pp:0,gf:4,gc:0,pts:4},{nombre:'Uruguay',pj:1,pg:0,pe:1,pp:0,gf:1,gc:1,pts:1},{nombre:'Islas de Cabo Verde',pj:1,pg:0,pe:1,pp:0,gf:0,gc:0,pts:1},{nombre:'Arabia Saudí',pj:2,pg:0,pe:1,pp:1,gf:1,gc:5,pts:1}] },
...
// Generado automáticamente — 2026-06-21T21:03:42.645Z
