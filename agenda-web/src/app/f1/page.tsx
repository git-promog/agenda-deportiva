...
export default async function F1Hub() {
  ...
  const eventosF1 = eventos || [];
  const enVivo = eventosF1.filter(e => estaEnVivo(e.fecha, e.hora, hoyStr));
    ...
    <>
      ...
      <div className="min-h-screen bg-[#020617] text-slate-100 font-sans pb-24">
        <div className="max-w-4xl mx-auto px-4 pt-10">
          <Breadcrumbs items={[]} current="Fórmula 1" />
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-5xl font-black italic uppercase leading-[0.95] tracking-tighter">
                  Fórmula 1 <span className="text-[#a3e635]">en Vivo</span>
                </h1>
                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-2">
                  Dónde ver carreras hoy en México
                </p>
              </div>
            </div>
          </header>
            ...
            <section className="mb-12">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-[10px] font-black text-red-500 uppercase tracking-[0.3em]">
                  {enVivo.length} carrera{enVivo.length > 1 ? 's' : ''} en vivo
                </h2>
              </div>
          ...
          {Object.keys(eventosAgrupados).length > 0 ? (
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-[32px] p-16 text-center text-slate-500">
              ...
              <p className="font-bold text-lg mb-2 text-slate-400">No hay carreras de Fórmula 1 próximamente</p>
