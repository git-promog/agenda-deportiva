...
export const metadata: Metadata = {
  title: "MLB en Vivo | Dónde Ver Partidos Hoy en México | GuíaSports",
  description: "Horarios y canales de TV para ver MLB en vivo en México. Dónde ver partidos de béisbol hoy.",
  alternates: {
    canonical: "https://www.guiasports.com/mlb",
  },
  openGraph: {
    title: "MLB en Vivo | Dónde Ver Partidos Hoy en México",
...
export default async function MlbHub() {
  ...
  const eventosBeisbol = eventos || [];
  const enVivo = eventosBeisbol.filter(e => estaEnVivo(e.fecha, e.hora, hoyStr));
